...
const contributors = [
  {
    name: 'Kwame Mensah',
    role: 'Pastor & Theologian',
    location: 'Accra, Ghana',
    focus: 'Biblical theology and public faith',
  },
  {
    name: 'Nomsa Dlamini',
    role: 'Writer & Bible Teacher',
    location: 'Johannesburg, South Africa',
    focus: 'Discipleship and Christian living',
  },
  {
    name: 'Daniel Adebayo',
    role: 'Pastor & Author',
    location: 'Lagos, Nigeria',
    focus: 'The local church and gospel ministry',
  },
]

export default function AfricanVoices() {
  return (
      ...
      <div className="page-shell">
        ...
        <div className="grid border-t border-midnight-navy/15 md:grid-cols-3">
          {contributors.map((contributor, index) => (
            ...
            >
              <span className="eyebrow text-[9px] text-midnight-navy">{contributor.location}</span>
              ...
              <p className="mt-6 text-sm leading-6 text-charcoal-text/50">{contributor.focus}</p>
