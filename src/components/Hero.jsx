  ...
  return (
    <header id="top" className="relative flex min-h-[78vh] items-center overflow-hidden bg-white py-24 md:min-h-[86vh]">
      ...
      <div className="page-shell relative z-10 text-center">
        ...
        <h1 className="hero-reveal hero-delay-1 mx-auto max-w-6xl font-display text-[clamp(3.3rem,8vw,7rem)] font-medium leading-[0.92] tracking-[-0.035em] text-midnight-navy">
          Ancient truth.
          <br />
