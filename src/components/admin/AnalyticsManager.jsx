    ...
    <main className="admin-scroll min-h-0 flex-1 overflow-y-auto bg-slate-50/50 px-6 pb-10 pt-6 xl:px-10">
      <div className="admin-report mx-auto max-w-[1180px]">
        <div className="admin-report-toolbar mb-6 overflow-visible rounded-[32px] bg-gradient-to-br from-[#07182d] via-midnight-navy to-[#24486f] px-7 py-8 text-white shadow-[0_24px_70px_rgba(13,34,64,0.20)] md:px-10 md:py-10">
          {dailyScripture && <div className="mb-7 flex items-center gap-4 border-b border-white/10 pb-5"><span className="shrink-0 text-[9px] font-bold uppercase tracking-[0.16em] text-heritage-gold">Daily Scripture</span><div className="admin-scripture-marquee min-w-0 flex-1 overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_7%,black_93%,transparent)]"><div className="admin-scripture-marquee-track flex w-max items-center gap-4 whitespace-nowrap font-display text-[15px] italic tracking-[0.01em] text-white/80 md:text-[17px]"><span className="font-sans text-[10px] font-semibold not-italic uppercase tracking-[0.12em] text-white/40">{dailyScripture.reference}</span><span className="admin-scripture-copy [&_.copyright]:ml-2 [&_.copyright]:inline [&_.copyright]:font-sans [&_.copyright]:text-[9px] [&_.copyright]:not-italic [&_.verse-num]:mr-1 [&_.verse-num]:font-sans [&_.verse-num]:text-[9px] [&_p]:inline" dangerouslySetInnerHTML={{ __html: dailyScripture.html }} /></div></div></div>}
